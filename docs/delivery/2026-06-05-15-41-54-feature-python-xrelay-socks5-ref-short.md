...
- 更新 `tests/fixtures/example-project/stacks/auto.yaml` 和内置模板，统一使用 `usa1.relay`、`usa2.relay`。
...
- `.venv/bin/proxystack-agent validate -c tests/fixtures/example-project/config.yaml`：通过
